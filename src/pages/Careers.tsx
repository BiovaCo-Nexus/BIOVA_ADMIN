  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] selection:bg-accent/20 selection:text-primary font-sans overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute top-[10%] -left-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-tr from-accent/5 to-transparent blur-[120px]" />
        <div className="absolute -top-[10%] -right-[10%] w-[60%] h-[60%] rounded-full bg-gradient-to-br from-primary/5 to-transparent blur-[120px]" />
      </div>
      ...
      <section className="pt-32 pb-16 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left mt-8">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 text-primary tracking-tight leading-[1.1]">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-[#0a4b91] to-accent">
              scalable technology.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            <a href="#open-positions" className="w-full sm:w-auto">
              <Button size="lg" className="rounded-full px-8 h-14 text-base bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg shadow-primary/20 hover:scale-105 transition-all duration-300 w-full">
                View Open Positions
              </Button>
            </a>
            <a href="#application-tracker" className="w-full sm:w-auto">
              <Button variant="outline" size="lg" className="rounded-full px-8 h-14 text-base border-gray-200 bg-white/50 backdrop-blur-sm hover:bg-white hover:text-accent hover:border-accent/30 w-full transition-all duration-300 shadow-sm">
                Track Application
              </Button>
            </a>
          </div>
      ...
      <section id="open-positions" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col sm:flex-row justify-between items-end gap-6 mb-12">
          ...
          <div className="bg-white rounded-full px-5 py-2.5 border border-gray-100 shadow-sm flex items-center gap-3">
        ...
        {loading ? (
          <div className="text-center py-20 bg-white/50 backdrop-blur-sm rounded-[2.5rem] border border-gray-100/50 shadow-sm">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {positions.map((position) => (
              <Card key={position.id} className="border border-gray-100/80 shadow-xl shadow-gray-200/30 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500 flex flex-col h-full rounded-[2rem] bg-white group hover:border-primary/20 overflow-hidden relative">
          ...
          <div className="text-center py-20 bg-white/50 backdrop-blur-sm rounded-[3rem] border border-gray-100/50 shadow-sm">
