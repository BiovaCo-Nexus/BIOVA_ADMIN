...
export function LocationManagement() {
 ...
 return (
 <Card className="border-border" style={{ backgroundColor: "#E6F2E6" }}>
 <CardHeader>
 ...
 <div className="h-32 bg-primary/10 rounded-lg overflow-hidden">
 <iframe
 ...
 <Button onClick={() => setIsEditing(true)} className="bg-primary/10 hover:bg-primary/10 text-white">
 ...
 <Button onClick={handleSave} disabled={isLoading} className="w-full sm:w-auto bg-primary/10 hover:bg-primary/10 text-white">
 ...
 variant="outline"
 className="w-full sm:w-auto border-border text-foreground hover:bg-muted/50"
 >
 Cancel
 </Button>
 </div>
