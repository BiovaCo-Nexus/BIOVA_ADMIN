...
export function CustomersManagement() {
 ...
 <h3 className="text-lg font-semibold text-gray-800 flex items-center"><Users className="w-5 h-5 mr-2 text-foreground" /> Customers Directory</h3>
 <Button onClick={() => {
 ...
 <div className="md:col-span-2 flex justify-end"><Button onClick={handleSave} className="bg-secondary">Save Customer</Button></div>
 </CardContent>
 </Card>
 )}
 ...
 <Button size="sm" variant="ghost" onClick={() => handleEdit(c)}><Edit className="w-4 h-4 text-foreground" /></Button>
