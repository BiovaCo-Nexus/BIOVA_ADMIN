  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-800 flex items-center"><Truck className="w-5 h-5 mr-2 text-rose-600" /> Suppliers Directory</h3>
        <Button onClick={() => {
      ...
      {isAdding && (
        <Card className="bg-rose-50/50 border-rose-100">
          <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 flex justify-end"><Button onClick={handleSave} className="bg-rose-600">Save Supplier</Button></div>
          </CardContent>
        </Card>
      )}
              ...
              {suppliers.map(s => (
                <TableRow key={s.id}>
                  ...
                  <TableCell className="text-right">
                    <Button size="sm" variant="ghost" onClick={() => handleEdit(s)}><Edit className="w-4 h-4 text-blue-600" /></Button>
