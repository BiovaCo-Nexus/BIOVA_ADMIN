...
export function MaintenanceManagement() {
 ...
 <Alert
 className={
 formData.is_maintenance_mode ? "border-orange-200 bg-orange-50" : "border-border bg-muted/50"
 }
 >
 ...
 <AlertDescription className={formData.is_maintenance_mode ? "text-orange-800" : "text-foreground"}>
 {formData.is_maintenance_mode
