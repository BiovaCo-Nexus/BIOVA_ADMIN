...
export function InvoiceGenerator() {
 ...
 <div className="md:col-span-3 flex justify-end"><Button onClick={handleSave} className="bg-secondary">Save Invoice</Button></div>
 </CardContent>
 </Card>
 )}
 ...
 <Button size="sm" variant="ghost" onClick={() => handleEdit(inv)}><Edit className="w-4 h-4 text-foreground" /></Button>
