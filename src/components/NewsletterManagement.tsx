...
export function NewsletterManagement() {
 ...
 <h1 className="text-2xl font-bold text-foreground">Newsletter Subscribers ({newsletters.length})</h1>
 ...
 <TableHead className="text-foreground font-bold">Confirmed</TableHead>
 <TableHead className="text-foreground font-bold">Subscribed At</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {newsletters.map((sub) => (
 ...
 <TableCell>
 <Badge className={sub.confirmed ? "bg-primary/10 text-foreground" : "bg-red-100 text-red-800"}>
 {sub.confirmed ? "Yes" : "No"}
 </Badge>
 </TableCell>
 ...
 <span className="font-bold text-foreground break-all mr-2">{sub.email}</span>
 <Badge
 className={
 sub.confirmed ? "bg-primary/10 text-foreground shrink-0" : "bg-red-100 text-red-800 shrink-0"
 }
 >
