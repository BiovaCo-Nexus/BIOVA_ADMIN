    ...
    <>
      <section className="py-12 sm:py-16">
        <div className="text-center mb-8 sm:mb-12 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-50 via-purple-50 to-blue-50 rounded-3xl opacity-60"></div>
          <div className="relative py-8 px-4">
            <div
              className="inline-flex items-center gap-2 text-white px-4 py-2 rounded-full text-sm font-medium mb-4 shadow-lg"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
          {models.map((model) => (
            <Card
              key={model.id}
              className="border-0 hover:shadow-2xl transition-all duration-500 group overflow-hidden bg-white rounded-2xl shadow-lg hover:scale-[1.02]"
            >
              <div
                className="aspect-square overflow-hidden cursor-pointer relative bg-gradient-to-br from-gray-100 to-gray-200"
              ...
              <CardContent className="p-6 sm:p-8">
                ...
                <div className="flex items-center gap-6 pt-4 border-t border-gray-100">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => setSelectedModel(model)}
                    className="flex items-center gap-2 text-gray-600 px-3 py-2 rounded-full transition-all duration-200"
        ...
        <DialogContent className="max-w-6xl max-h-[95vh] overflow-y-auto bg-white rounded-3xl border-0 shadow-2xl">
          ...
          {selectedModel && (
            <div className="space-y-8 pt-6">
              <div className="w-full h-96 rounded-2xl overflow-hidden shadow-lg bg-gradient-to-br from-gray-100 to-gray-200">
              ...
              <div className="border-t border-gray-100 pt-8">
                <div className="flex items-center gap-6 mb-8">
                  <Button
                    ...
                    className={`flex items-center gap-3 px-6 py-3 rounded-full text-lg font-medium transition-all duration-200 ${
