...
export function DashboardAnalytics({ user, onNavigateToTab }: DashboardAnalyticsProps) {
 ...
 <Badge variant="outline" className="bg-muted/50 text-foreground border-border gap-1 text-[10px]">
 <span className="h-1.5 w-1.5 rounded-full bg-primary/10 animate-pulse" />
 Push Alerts Active
 </Badge>
 <Button 
 ...
 size="sm" 
 variant="outline" 
 className="h-6 text-[10px] px-2 py-0 border-border text-foreground hover:bg-muted/50"
 >
 Send Test 🔔
 </Button>
 </div>
 ...
 <div className="bg-muted/50 p-4 rounded-r-lg flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-in fade-in duration-300">
 <div className="flex items-start gap-3">
 <BellRing className="h-5 w-5 text-foreground shrink-0 mt-0.5" />
 <div>
 ...
 size="sm" 
 className="bg-primary hover:bg-primary/90 text-white font-semibold text-xs shrink-0 self-start sm:self-auto"
 >
 Enable Alerts 🔔
 </Button>
 </div>
 ...
 <div className="bg-red-50 p-4 rounded-r-lg flex items-start gap-3">
 ...
 className="h-5 w-5 rounded-full shrink-0 p-0 text-slate-400 hover:text-foreground transition-colors"
 ...
 <Card className="bg-[#4B49AC] text-white">
 ...
 <Card className="bg-muted/20 text-foreground ">
 <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
