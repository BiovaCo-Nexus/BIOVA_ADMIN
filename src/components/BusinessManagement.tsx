...
export function BusinessManagement() {
 ...
 <div className="bg-white p-2 rounded-xl border border-gray-100 flex gap-2 overflow-x-auto whitespace-nowrap scrollbar-hide">
 {subTabs.map((tab) => {
 const Icon = tab.icon;
 ...
 className={`flex-shrink-0 ${isActive ? 'bg-primary text-primary-foreground hover:bg-primary/90' : 'text-gray-600 hover:bg-gray-100'}`}
