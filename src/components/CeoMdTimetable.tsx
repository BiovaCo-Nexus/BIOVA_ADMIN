...
const CATEGORIES = {
  "Meeting": { bg: "bg-blue-50 border-blue-200 text-blue-800", color: "#3B82F6", pill: "bg-blue-500" },
  "Review": { bg: "bg-amber-50 border-amber-200 text-amber-800", color: "#F59E0B", pill: "bg-amber-500" },
  "Strategic Planning": { bg: "bg-purple-50 border-purple-200 text-purple-800", color: "#8B5CF6", pill: "bg-purple-500" },
  "Operations": { bg: "bg-emerald-50 border-emerald-200 text-emerald-800", color: "#10B981", pill: "bg-emerald-500" },
  "Personal": { bg: "bg-rose-50 border-rose-200 text-rose-800", color: "#EF4444", pill: "bg-rose-500" },
  "Site Visit": { bg: "bg-cyan-50 border-cyan-200 text-cyan-800", color: "#06B6D4", pill: "bg-cyan-500" },
  "Client Call": { bg: "bg-indigo-50 border-indigo-200 text-indigo-800", color: "#6366F1", pill: "bg-indigo-500" },
...
CREATE POLICY "ceo_md_timetable_delete_policy" ON public.ceo_md_timetable FOR DELETE TO authenticated USING (true);`;
  ...
  return (
    <div className="space-y-6">
      ...
      {isLocalMode && (
        <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-lg shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4 animate-pulse">
          <div className="flex items-center space-x-3">
            <AlertTriangle className="h-6 w-6 text-amber-600 shrink-0" />
            <div>
              <p className="font-semibold text-amber-900">Local Database Sandbox Mode Active</p>
              <p className="text-xs text-amber-700">
                The <code className="bg-amber-100 px-1 py-0.5 rounded">ceo_md_timetable</code> table is not active in the remote Supabase database. Changes are currently saved in your browser storage.
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-2 w-full md:w-auto">
            <Button
              ...
              className="text-amber-800 border-amber-300 bg-white hover:bg-amber-100 text-xs shrink-0"
            >
              Get SQL Setup Query
            </Button>
            <Button
              ...
              className="text-amber-800 hover:bg-amber-100 text-xs font-semibold shrink-0"
            >
              Load Demo Data
            </Button>
          </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        <div className="space-y-1">
          <div className="flex items-center space-x-3">
            <Calendar className="h-6 w-6 text-[#032E63]" />
            <h2 className="text-2xl font-bold text-[#032E63] tracking-tight">Executive Schedule Desk</h2>
          </div>
        ...
        <div className="flex items-center p-1 bg-gray-100 border border-gray-200 rounded-xl w-fit">
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 ${
              activeRole === "ceo"
                ? "bg-[#032E63] text-white shadow-sm"
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 ${
              activeRole === "md"
                ? "bg-[#08A04B] text-white shadow-sm"
                : "text-gray-600 hover:text-gray-900 hover:bg-gray-200/50"
            }`}
          >
            <User className="h-4 w-4" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <Card className="border-gray-200 shadow-sm">
            ...
            <CardContent className="space-y-3">
              <Button
                ...
                className="w-full bg-[#032E63] hover:bg-[#032E63]/90 text-white font-semibold flex items-center justify-center gap-2 shadow-sm transition-colors duration-200"
              >
              ...
              <Button
                ...
                className="w-full border-blue-200 text-blue-700 bg-blue-50/50 hover:bg-blue-100 font-semibold flex items-center justify-center gap-2"
              >
              ...
              <Button
                ...
                className="w-full border-emerald-200 text-emerald-700 bg-emerald-50/50 hover:bg-emerald-100 font-semibold flex items-center justify-center gap-2"
              >
              ...
              <Button
                ...
                className="w-full border-violet-200 text-violet-700 bg-violet-50/50 hover:bg-violet-100 font-semibold flex items-center justify-center gap-2"
              >
          ...
          <Card className="border-gray-200 shadow-sm">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-bold uppercase tracking-wider text-gray-500 flex items-center gap-2">
                <PieChart className="h-4 w-4 text-[#032E63]" />
                Weekly Work Balance
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <p className="text-2xl font-black text-[#032E63]">{timeAllocationStats.totalHours} hrs</p>
        ...
        <div className="lg:col-span-3 space-y-6">
            ...
            <div className="flex items-center border border-gray-200 rounded-lg p-0.5 bg-gray-50 shrink-0">
              <button
                ...
                className={`p-2 rounded-md transition-all ${
                  viewMode === "grid"
                    ? "bg-white text-[#032E63] shadow-sm font-semibold"
          ...
          <div id="printable-schedule-area" className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden p-6 relative">
            
            {/* PRINT-ONLY EMBEDDED HEADER */}
            <div className="hidden print:block mb-6 border-b pb-4">
              <div className="flex justify-between items-center">
                <div>
                  <h1 className="text-2xl font-black text-[#032E63]">BiovaCo Nexus Executive Timetable</h1>
                  <p className="text-sm text-gray-500">
                    Officially compiled schedule for the: <span className="font-bold text-[#08A04B]">{activeRole.toUpperCase()}</span>
                  </p>
                </div>
            ...
            {loading ? (
              <div className="py-20 flex flex-col items-center justify-center space-y-4">
                <RefreshCw className="h-8 w-8 animate-spin text-[#032E63]" />
                        ...
                        {(eventsByDay[day] || []).map(event => {
                          ...
                          return (
                            <div
                              ...
                              className={`absolute left-0.5 right-0.5 rounded-md border text-[10px] cursor-pointer overflow-hidden shadow-sm hover:shadow-md hover:z-10 transition-all duration-150 ${config?.bg}`}
                  ...
                  return (
                    <div key={day} className="space-y-3">
                      <div className="flex items-center space-x-2 border-b pb-1.5">
                        <span className="h-2 w-2 rounded-full bg-[#032E63]" />
                        <h4 className="font-bold text-[#032E63]">{day} Schedule</h4>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {dayEvents.map(event => {
                          ...
                          return (
                            <Card
                              key={event.id}
                              className={`border hover:shadow-md transition-all duration-200 ${config?.bg}`}
                            >
                              <CardContent className="p-4 flex justify-between items-start gap-4">
                                ...
                                <div className="flex items-center gap-1 shrink-0 bg-white/40 p-1 rounded-lg border border-gray-200/30">
                                  <Button
                                    ...
                                    variant="ghost"
                                    onClick={() => handleOpenEditDialog(event)}
                                    className="h-7 w-7 text-gray-700 hover:text-blue-600 hover:bg-white"
                                  >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-md bg-white">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-lg font-bold text-[#032E63]">
              <Clock className="h-5 w-5 text-[#032E63]" />
          ...
          <form onSubmit={handleSaveEvent} className="space-y-4 pt-2">
            ...
            <DialogFooter className="pt-4 flex items-center justify-between gap-2 border-t">
              ...
              <div className="flex gap-2">
                ...
                <Button type="submit" className="bg-[#032E63] hover:bg-[#032E63]/90 text-white font-semibold">
      ...
      <Dialog open={isSqlDialogOpen} onOpenChange={setIsSqlDialogOpen}>
        <DialogContent className="max-w-xl bg-white">
          <DialogHeader>
            ...
            <DialogDescription>
              Execute this SQL snippet in the Supabase SQL Editor of your project dashboard (<a href="https://supabase.com" target="_blank" rel="noreferrer" className="text-blue-600 font-bold underline">https://supabase.com</a>) to establish permanent cloud-based synchronization.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter className="pt-2 border-t mt-4">
            <Button onClick={() => setIsSqlDialogOpen(false)} className="bg-[#032E63] text-white">
              Close Instructions
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={isCopyDialogOpen} onOpenChange={setIsCopyDialogOpen}>
        <DialogContent className="max-w-md bg-white">
          ...
          <DialogFooter className="pt-4 border-t mt-4">
            ...
            <Button onClick={handleCopyDaySchedule} className="bg-[#032E63] hover:bg-[#032E63]/90 text-white font-semibold">
              Copy Schedule
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={isBulkDialogOpen} onOpenChange={setIsBulkDialogOpen}>
        <DialogContent className="max-w-lg bg-white">
          ...
          <div className="space-y-3 pt-1">
            {/* Example hint */}
            <div className="bg-gray-900 rounded-lg p-3 text-[11px] font-mono text-green-400 space-y-0.5">
