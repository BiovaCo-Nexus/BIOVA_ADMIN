...
export function InventoryManagement() {
 ...
 <div className="md:col-span-3 flex justify-end"><Button onClick={handleSave} className="bg-primary text-primary-foreground">Save Item</Button></div>
 </CardContent>
 </Card>
 )}
 ...
 <Button size="sm" variant="ghost" onClick={() => handleEdit(item)}><Edit className="w-4 h-4 text-foreground" /></Button>
