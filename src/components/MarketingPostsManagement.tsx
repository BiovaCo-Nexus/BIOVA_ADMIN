...
export function MarketingPostsManagement() {
 ...
 {editingPost ? (
 <>
 <Button onClick={handleUpdatePost} className="w-full sm:w-auto bg-secondary text-secondary-foreground hover:bg-secondary text-secondary-foreground/90 text-white">
 Update Post
 </Button>
 ...
 <Button onClick={handleCreatePost} className="w-full sm:w-auto bg-secondary text-secondary-foreground hover:bg-secondary text-secondary-foreground/90 text-white">
 Create Post
 </Button>
 )}
 </div>
 ...
 <span
 className={`px-2 py-1 rounded-md text-xs font-medium shrink-0 ${post.is_published ? "bg-secondary text-secondary-foreground/10 text-muted-foreground" : "bg-gray-100 text-gray-800"}`}
 >
 ...
 <span key={index} className="bg-primary text-primary-foreground/10 text-foreground text-xs font-medium px-2 py-1 rounded-md">
 #{tag}
 </span>
 ))}
 </div>
