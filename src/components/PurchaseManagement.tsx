...
export function PurchaseManagement() {
 ...
 <h3 className="text-xl font-bold text-foreground">₹{totalPayables.toLocaleString('en-IN')}</h3>
 </CardContent>
 </Card>
 </div>
 ...
 <div className="md:col-span-3 flex justify-end"><Button onClick={handleSave} className="bg-secondary">Save PO</Button></div>
 </CardContent>
 </Card>
 )}
 ...
 <TableCell className="font-bold text-foreground">₹{Number(order.total_amount - order.amount_paid).toLocaleString('en-IN')}</TableCell>
 <TableCell>
 ...
 <Button size="sm" variant="ghost" onClick={() => handleEdit(order)}><Edit className="w-4 h-4 text-foreground" /></Button>
