...
export const VideoManagement: React.FC = () => {
 ...
 case 'story': return 'bg-primary text-primary-foreground text-foreground';
 case 'intro': return 'bg-secondary text-foreground';
 ...
 <Button onClick={openAddDialog} className="w-full sm:w-auto bg-secondary text-secondary-foreground hover:bg-secondary text-secondary-foreground/90 text-white">
 ...
 <Button type="submit" disabled={loading} className="bg-primary/10 hover:bg-primary/10">
 ...
 {videos.map((video) => (
 <Card key={video.id} className="p-4 flex flex-col gap-3">
 <div className="flex justify-between items-start">
 <h3 className="font-bold text-foreground pr-2">{video.title}</h3>
