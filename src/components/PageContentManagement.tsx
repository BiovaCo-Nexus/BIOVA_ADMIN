...
const PageContentManagement = () => {
 ...
 <Button className="w-full sm:w-auto bg-primary text-primary-foreground hover:bg-primary/90" onClick={handleSave} disabled={saving}>
 ...
 <p className="text-sm text-foreground mb-2">✓ Valid video URL detected</p>
