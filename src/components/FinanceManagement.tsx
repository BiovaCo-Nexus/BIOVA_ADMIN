      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button variant="default" size="sm" onClick={() => generatePDFReport("Income Ledger", false)} className="flex-1 sm:flex-none bg-indigo-600 hover:bg-indigo-700 text-white"><Printer className="w-4 h-4 mr-1" /> Print</Button>
            <Button onClick={() => {
              if (isAddingIncome) {
                setIsAddingIncome(false);
                setEditingIncomeId(null);
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button variant="default" size="sm" onClick={() => generatePDFReport("Expense Ledger", false)} className="bg-indigo-600 hover:bg-indigo-700 text-white"><Printer className="w-4 h-4 mr-1" /> Print</Button>
            <Button onClick={() => {
              if (isAddingExpense) {
                setIsAddingExpense(false);
                setEditingExpenseId(null);
      ...
      <div className="space-y-4">
            ...
            <Card key={r.type} className={`hover:border-${r.color}-300 transition-colors`}>
              <CardContent className="p-5 flex flex-col items-center text-center space-y-3">
                ...
                <div className="flex gap-2 w-full mt-2">
                  ...
                  <Button variant="default" size="sm" className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white" onClick={() => generatePDFReport(r.type, false)}><Printer className="w-4 h-4 mr-1" /> Print</Button>
                </div>
              </CardContent>
            </Card>
          ))}
        ...
        <Card className="mt-4 border-dashed">
          <CardContent className="p-4 flex flex-wrap gap-3 items-center justify-center">
            ...
            <Button variant="default" size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white" onClick={() => generatePDFReport("Expense Ledger", false)}><Printer className="w-4 h-4 mr-1" /> Print Expenses</Button>
          </CardContent>
        </Card>
      </div>
    )}
