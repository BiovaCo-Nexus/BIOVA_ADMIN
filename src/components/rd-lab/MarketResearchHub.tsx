...
const CATEGORIES = [
 { value: "market_opportunity", label: "Market Opportunity", color: "bg-primary text-primary-foreground text-foreground border-border" },
 { value: "competitor_intel", label: "Competitor Intelligence", color: "bg-red-100 text-red-800 border-red-200" },
 { value: "consulting_advice", label: "Consulting / Advisory", color: "bg-secondary text-foreground border-border" },
 { value: "strategic_idea", label: "Strategic Idea", color: "bg-secondary text-foreground border-border" }
]

const STATUSES = [
 { value: "under_review", label: "Under Review", color: "bg-slate-100 text-slate-800" },
 { value: "approved", label: "Approved", color: "bg-secondary text-foreground" },
...
export function MarketResearchHub() {
 ...
 {/* Header Banner */}
 <div className="bg-primary text-primary-foreground p-6 rounded-xl relative overflow-hidden border-border">
 ...
 <span className="bg-secondary text-secondary-foreground text-xs font-bold uppercase px-2.5 py-1 rounded-full">CEO & MD Workspace</span>
 {isMockMode && (
 <Badge className="bg-secondary hover:bg-secondary text-white flex items-center gap-1 border-0">
 ...
 <p className="text-foreground max-w-2xl text-sm md:text-base">
 ...
 <h3 className="text-2xl font-black text-foreground">{totalItems}</h3>
 </div>
 <div className="h-10 w-10 bg-muted/50 rounded-lg flex items-center justify-center text-foreground"><Briefcase className="h-5 w-5" /></div>
 </CardContent>
 </Card>
 <Card className=" bg-white">
 <CardContent className="p-4 flex items-center justify-between">
 ...
 <h3 className="text-2xl font-black text-foreground">{items.filter(i => i.category === 'consulting_advice').length}</h3>
 </div>
 <div className="h-10 w-10 bg-muted/50 rounded-lg flex items-center justify-center text-foreground"><BrainCircuit className="h-5 w-5" /></div>
 </CardContent>
 </Card>
 <Card className=" bg-white">
 <CardContent className="p-4 flex items-center justify-between">
 ...
 <CardHeader className="bg-muted/50/50 pb-4 border-b border-border/50">
 ...
 <h4 className="font-semibold text-sm text-foreground">Key Takeaways & Core Findings</h4>
 ...
 />
 <Button type="button" onClick={addTakeaway} className="bg-primary text-primary-foreground">Add</Button>
 </div>
 ...
 <Button type="submit" disabled={isSaving} className="bg-primary text-primary-foreground hover:bg-primary/90 text-white font-semibold">
 ...
 activeSubTab === "all" ? "bg-primary text-primary-foreground border-transparent" : "bg-gray-50 text-gray-600 hover:bg-gray-100"
 }`}
 >
 All Insights
 </button>
 ...
 className={`px-4 py-1.5 rounded-full text-xs font-semibold border transition-all ${
 activeSubTab === cat.value ? "bg-primary text-primary-foreground border-transparent" : "bg-gray-50 text-gray-600 hover:bg-gray-100"
 }`}
 >
 {cat.label}
 </button>
 ...
 <Button onClick={() => { resetForm(); setIsEditing(true) }} className="bg-primary text-primary-foreground hover:bg-primary/90 text-white text-xs font-semibold">
 ...
 return (
 <Card key={item.id} className="hover: ">
 ...
 <CardTitle className="text-foreground text-lg font-bold hover:text-foreground transition-colors">
 {item.title}
 </CardTitle>
 ...
 <Button variant="ghost" size="icon" className="h-8 w-8 text-foreground" onClick={() => handleEdit(item)}>
 ...
 <div className="flex gap-2 items-start bg-muted/50/20 p-2.5 rounded-lg border border-border text-xs text-rose-950">
 ...
 <span className="text-muted-foreground font-extrabold text-sm leading-none">•</span>
 ...
 {item.action_plan && (
 <div className="flex gap-2 items-start bg-muted/50/30 p-3 rounded-lg border border-border text-xs">
 <Flame className="h-4 w-4 text-foreground mt-0.5 flex-shrink-0" />
 <div>
 <strong className="text-foreground">Execution Plan:</strong> {item.action_plan}
 </div>
 </div>
 )}
 </CardContent>
