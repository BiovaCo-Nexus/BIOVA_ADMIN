...
export function ProductTesting() {
 ...
 <h2 className="text-xl font-bold text-foreground">Product Testing (Score Cards)</h2>
 {!isEditing && <Button onClick={() => { resetForm(); setIsEditing(true) }} className="bg-primary text-primary-foreground hover:bg-primary/90"><Plus className="h-4 w-4 mr-2" />Log Test</Button>}
 </div>
 ...
 <div className="flex justify-between items-center">
 <CardTitle className="text-foreground">{form.id ? "Edit Test" : "New Test Record"}</CardTitle>
 ...
 <h4 className="font-medium text-sm text-foreground mb-3">Evaluation Scores (0-10)</h4>
