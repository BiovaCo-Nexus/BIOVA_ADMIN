...
export function RDDashboard({ onNavigate }: { onNavigate: (tab: string) => void }) {
 ...
 const cards = [
 { label: "Total Recipes", value: stats.totalRecipes, icon: FlaskConical, color: "text-foreground", bg: "bg-muted/50", border: "border-border", tab: "recipes" },
 { label: "Approved Recipes", value: stats.approvedRecipes, icon: ShieldCheck, color: "text-foreground", bg: "bg-muted/50", border: "border-border", tab: "recipes" },
 { label: "Under Development", value: stats.devRecipes, icon: Beaker, color: "text-foreground", bg: "bg-muted/50", border: "border-border", tab: "recipes" },
 { label: "Batch Trials", value: stats.totalTrials, icon: TestTubes, color: "text-foreground", bg: "bg-muted/50", border: "border-border", tab: "trials" },
 { label: "Raw Materials", value: stats.totalMaterials, icon: Package, color: "text-foreground", bg: "bg-muted/50", border: "border-border", tab: "materials" },
 ...
 { label: "Suppliers", value: stats.totalSuppliers, icon: Truck, color: "text-foreground", bg: "bg-muted/50", border: "border-border", tab: "suppliers" },
 ...
 <div>
 <h2 className="text-xl font-bold text-foreground">R&D Lab Dashboard</h2>
 <p className="text-sm text-gray-500">Real-time overview of all lab operations</p>
 </div>
 <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
 {cards.map(c => (
 <Card key={c.label} className={`${c.bg} border ${c.border} shadow-sm cursor-pointer hover: transition-shadow`} onClick={() => onNavigate(c.tab)}>
 ...
 <CardHeader className="bg-muted/50/50 pb-4 border-b border-border">
 ...
 <div className="bg-secondary p-2 rounded-full text-foreground shrink-0"><FlaskConical className="h-4 w-4" /></div>
 ...
 <div className="flex items-start gap-3">
 <div className="bg-primary text-primary-foreground p-2 rounded-full text-foreground shrink-0"><TestTubes className="h-4 w-4" /></div>
 ...
 <div className="flex items-start gap-3">
 <div className="bg-secondary p-2 rounded-full text-foreground shrink-0"><BookOpen className="h-4 w-4" /></div>
 ...
 <div className="flex items-start gap-3">
 <div className="bg-primary/10 p-2 rounded-full text-foreground shrink-0"><ShieldCheck className="h-4 w-4" /></div>
