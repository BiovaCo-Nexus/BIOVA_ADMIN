  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold text-[#032E63]">Manufacturing SOPs</h2>
        {!isEditing && <Button onClick={() => { resetForm(); setIsEditing(true) }} className="bg-[#08A04B] hover:bg-[#069a43]"><Plus className="h-4 w-4 mr-2" />New SOP</Button>}
      </div>
      ...
      {isEditing ? (
        <Card className="border-l-4 border-l-[#08A04B] shadow-md">
          <CardHeader className="pb-3">
            <div className="flex justify-between items-center">
              <CardTitle className="text-[#032E63]">{form.id ? "Edit SOP" : "Create SOP"}</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between"><label className="text-sm font-semibold text-[#032E63]">Step-by-Step Procedure</label>
            ...
            <Table><TableHeader><TableRow>
              ...
              <TableBody>{sops.map(s => (
                <TableRow key={s.id}>
                  ...
                  <TableCell>
                    <Badge variant="outline" className={s.status === 'active' ? "bg-green-100 text-green-700 border-green-200" : s.status === 'archived' ? "bg-gray-100 text-gray-700" : "bg-amber-100 text-amber-700"}>
