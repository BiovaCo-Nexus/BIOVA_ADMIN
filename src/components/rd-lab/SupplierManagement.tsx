...
export function SupplierManagement() {
 ...
 {!isEditing && <Button onClick={() => { resetForm(); setIsEditing(true) }} className="bg-primary text-primary-foreground hover:bg-primary/90"><Plus className="h-4 w-4 mr-2" />Add Supplier</Button>}
 </div>
 ...
 <div className="flex justify-between items-center">
 <CardTitle className="text-foreground">{form.id ? "Edit Supplier" : "New Supplier"}</CardTitle>
 ...
 <Star className={`h-4 w-4 ${s.rating > 0 ? "text-foreground fill-amber-400" : "text-gray-300"}`} />
