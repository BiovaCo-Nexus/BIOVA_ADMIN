...
export function RecipeFormulation() {
 ...
 if (s === "approved") return "bg-primary/10 text-foreground"
 if (s === "testing") return "bg-primary text-primary-foreground text-foreground"
 ...
 <h2 className="text-xl font-bold text-foreground">Recipe Formulation</h2>
 {!isEditing && !isPasting && (
 ...
 <Button onClick={() => { resetForm(); setIsEditing(true) }} className="bg-primary text-primary-foreground hover:bg-primary/90"><Plus className="h-4 w-4 mr-2" />New Recipe</Button>
 </div>
 )}
 </div>
 ...
 <ClipboardCheck className="h-5 w-5 text-foreground" /> Excel/Sheets Recipe Import
 </CardTitle>
 ...
 <CardHeader className="pb-3">
 <div className="flex justify-between items-center">
 <CardTitle className="text-foreground">{form.id ? "Edit Recipe" : "New Recipe"}</CardTitle>
 ...
 <div className="flex items-center justify-between"><label className="text-sm font-semibold text-foreground">Ingredients</label>
 <div className="flex gap-2">
 <Button type="button" variant="outline" size="sm" onClick={() => { setPasteIngredientsText(""); setIsPastingIngredients(true) }} className="border-border text-foreground hover:bg-muted/50"><ClipboardCheck className="h-3 w-3 mr-1" />Paste List</Button>
 ...
 <Card className="border border-border bg-muted/50/30 p-4 space-y-3">
 <div className="flex justify-between items-center">
 <h4 className="text-xs font-bold text-foreground">Paste Ingredients (Excel format: Ingredient [Tab] Percentage)</h4>
 ...
 <Button type="button" size="sm" onClick={handlePasteIngredients} disabled={!pasteIngredientsText.trim()} className="bg-secondary hover:bg-secondary text-white">Import List</Button>
 </div>
 </Card>
 )}
 ...
 {/* Steps */}
 <div className="space-y-2">
 <div className="flex items-center justify-between"><label className="text-sm font-semibold text-foreground">Manufacturing Steps</label>
 ...
 <Button variant="ghost" size="icon" onClick={() => handleEdit(r)}><Edit className="h-4 w-4 text-foreground" /></Button>
