  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold text-[#032E63]">QC Checklists</h2>
        {!isEditing && <Button onClick={() => { resetForm(); setIsEditing(true) }} className="bg-[#08A04B] hover:bg-[#069a43]"><Plus className="h-4 w-4 mr-2" />New QC Form</Button>}
      </div>
      ...
      {isEditing ? (
        <Card className="border-l-4 border-l-[#08A04B] shadow-md">
          <CardHeader className="pb-3">
            <div className="flex justify-between items-center">
              <CardTitle className="text-[#032E63]">{form.id ? "Edit QC Form" : "New QC Form"}</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                <h4 className="font-medium text-sm text-[#032E63] mb-3">Parameters</h4>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  {QC_FIELDS.map(f => (
            ...
            <Table><TableHeader><TableRow>
              ...
              <TableBody>{lists.map(t => (
                <TableRow key={t.id}>
                  ...
                  <TableCell>
                    <Badge variant="outline" className={t.passed ? "bg-green-100 text-green-700 border-green-200" : "bg-red-100 text-red-700 border-red-200"}>
