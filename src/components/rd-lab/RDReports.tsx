...
export function RDReports() {
 ...
 return `<strong style="color: ${val ? '#71717a' : '#e53e3e'}">${val ? 'YES' : 'NO'}</strong>`;
 }
 ...
 border-bottom: 3px solid #18181b; padding-bottom: 15px; margin-bottom: 25px;
 }
 .brand { color: #18181b; font-size: 24pt; font-weight: 800; letter-spacing: -0.5px; margin: 0; }
 ...
 th { 
 background-color: #fafafa; color: #18181b; font-weight: 700; 
 ...
 <div>
 <h2 className="text-xl font-bold text-foreground">R&D Data Reports</h2>
 ...
 <Card className=" ">
 <CardHeader>
 <CardTitle className="flex items-center text-lg"><Database className="h-5 w-5 mr-2 text-foreground" /> Data Extraction</CardTitle>
 ...
 className="flex-1 bg-primary text-primary-foreground hover:bg-primary/90 text-white"
 >
