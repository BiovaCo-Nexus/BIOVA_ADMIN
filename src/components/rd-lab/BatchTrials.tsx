...
export function BatchTrials() {
 ...
 <h2 className="text-xl font-bold text-foreground">Batch Trials</h2>
 {!isEditing && <Button onClick={() => { resetForm(); setIsEditing(true) }} className="bg-primary text-primary-foreground hover:bg-primary/90"><Plus className="h-4 w-4 mr-2" />Log New Trial</Button>}
 </div>
 ...
 <div className="flex justify-between items-center">
 <CardTitle className="text-foreground">{form.id ? "Edit Trial" : "New Batch Trial"}</CardTitle>
 ...
 <h4 className="font-medium text-sm text-foreground mb-3">Organoleptic Scores (0-10)</h4>
 ...
 <TableCell>
 <Badge variant="outline" className={t.final_decision === 'approved' ? "bg-primary/10 text-foreground border-border" : t.final_decision === 'rejected' ? "bg-red-100 text-red-700 border-red-200" : t.final_decision === 'needs_tweaking' ? "bg-secondary text-foreground border-border" : "bg-gray-100 text-gray-700"}>
