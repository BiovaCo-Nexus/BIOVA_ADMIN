...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const emailResponse = await resend.emails.send({
      from: "BiovaCo Nexus <onboarding@resend.dev>",
      to: [email],
      subject: "Application Confirmation - BiovaCo Nexus",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #FAFAF0;">
          <div style="background-color: #E6F2E6; padding: 30px; border-radius: 10px; text-align: center; border: 2px solid #4B49AC;">
            <h1 style="color: #222222; margin-bottom: 20px;">Application Received Successfully!</h1>
            
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin: 20px 0; border: 1px solid #4B49AC;">
              <h2 style="color: #4B49AC; margin-bottom: 15px;">Application Details</h2>
              ...
              ${applicationId ? `
                <div style="background-color: #F0FDF4; padding: 15px; border-radius: 6px; margin: 15px 0;">
                  ...
                  <p style="color: #4B49AC; font-size: 18px; font-weight: bold; font-family: monospace; margin: 5px 0;">${applicationId}</p>
            ...
            <div style="background-color: white; padding: 20px; border-radius: 8px; margin: 20px 0; text-align: left;">
              ...
              <ul style="color: #444444; line-height: 1.6;">
                ...
                <li>We'll contact you with updates</li>
            ...
            <div style="margin: 30px 0;">
              <p style="color: #444444; font-size: 16px; line-height: 1.6;">
                Thank you for your interest in joining BiovaCo Nexus. We're excited about the possibility of working together to innovate sustainable agricultural biotechnology.
              </p>
            </div>
            
            <div style="border-top: 1px solid #4B49AC; padding-top: 20px; margin-top: 30px;">
              <p style="color: #666666; font-size: 14px;">
                Best regards,<br>
                <strong style="color: #222222;">The BiovaCo Nexus Team</strong><br>
